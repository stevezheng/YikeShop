//by stevezheng
var localhost = 'http://192.168.199.140:3000';
var masterKey = 'ghqXlGVI6m6qxTBeSAVz1w9D';
(function(root) {
  root.AV = root.AV || {};
...
(function(root) {
  ...
  AV._ajax = function(method, url, data, success, error) {
    ...
    if (url.slice(0, 5) != 'https') {
      ...
      //by stevezheng
      if(AV.User.current()) {
        xhr.setRequestHeader("X-AVOSCloud-Session-Token", AV.User.current()._sessionToken);
      }
    }
    if (AV._isNode) {
